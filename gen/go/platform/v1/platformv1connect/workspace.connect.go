...
const (
	...
	WorkspaceServiceName = "platform.v1.WorkspaceService"
)
...
const (
	...
	// CreateWorkspace RPC.
	WorkspaceServiceCreateWorkspaceProcedure = "/platform.v1.WorkspaceService/CreateWorkspace"
)

// WorkspaceServiceClient is a client for the platform.v1.WorkspaceService service.
...
// NewWorkspaceServiceClient constructs a client for the platform.v1.WorkspaceService service. By
...
func NewWorkspaceServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) WorkspaceServiceClient {
	...
	workspaceServiceMethods := v1.File_platform_v1_workspace_proto.Services().ByName("WorkspaceService").Methods()
...
// CreateWorkspace calls platform.v1.WorkspaceService.CreateWorkspace.
...
// WorkspaceServiceHandler is an implementation of the platform.v1.WorkspaceService service.
...
func NewWorkspaceServiceHandler(svc WorkspaceServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/platform.v1.WorkspaceService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedWorkspaceServiceHandler) CreateWorkspace(context.Context, *connect.Request[v1.CreateWorkspaceRequest]) (*connect.Response[v1.CreateWorkspaceResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("platform.v1.WorkspaceService.CreateWorkspace is not implemented"))
}
